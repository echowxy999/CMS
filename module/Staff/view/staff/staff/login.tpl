...
<!--                            </div>-->
                        ...
                        <form class="" action="" method="post">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="checkbox-signin" name="rememberMe" checked>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        ...
                        <p class="text-white-50"> <a href="auth-register.html" class="text-white ms-1"><b>Sign Up</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
